...
export const Route = createFileRoute("/services/leadership-assessment")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Predictive insight into capability, fit, and trajectory at the most consequential roles." },
      { property: "og:title", content: "Leadership Assessment" },
      { property: "og:description", content: "Calibrated executive assessment, designed by senior practitioners." },
    ],
  }),
  component: () => (
    <ServiceTemplate
      ...
      whatWeDeliver={[
        { t: "Individual Executive Assessment", d: "Behavioral, cognitive, and contextual data on fit, capability, and trajectory." },
        { t: "Top Team Calibration", d: "A clear-eyed view of the executive team — together, not just individually." },
        { t: "Succession Readiness", d: "Bench mapping with development paths, not just rankings." },
        { t: "Pre-Deal Management Diligence", d: "Independent assessment of the team an investor is underwriting." },
        { t: "Post-Close Calibration", d: "First-100-day clarity on the team you actually have." },
        { t: "Development Architecture", d: "Targeted growth plans built from the assessment data — not generic frameworks." },
      ]}
      outcomes={[
