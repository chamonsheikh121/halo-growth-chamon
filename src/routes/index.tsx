  ...
  head: () => ({
    meta: [
      { title: "HALO Growth Partners — Integrated Growth. Grounded in Strategy." },
      {
        name: "description",
        content:
          "Executive consulting partnering with leadership teams, investors, and organizations navigating growth, transformation, and critical inflection points.",
      },
      { property: "og:title", content: "HALO Growth Partners" },
      {
        property: "og:description",
        content: "Integrated growth, grounded in strategy, driven by leadership.",
      },
    ],
  }),
  component: Home,
...
const gaps = [
  {
    n: "01",
    t: "Leadership Misalignment",
    d: "Strategy fractures at the top before it ever reaches the org. Teams optimize locally, decisions stall, and momentum quietly erodes.",
  },
  {
    n: "02",
    t: "Execution Friction",
    d: "Operating models lag strategic intent. Decision rights, cadence, and accountability haven't caught up to where the business is going.",
  },
  {
    n: "03",
    t: "Talent Risk at the Top",
    d: "Critical roles are unprepared, unfilled, or misfit. Succession is reactive, and bench strength is measured in hope, not data.",
  },
  {
    n: "04",
    t: "Scaling Without a Spine",
    d: "Complexity outpaces clarity. Structure, culture, and governance haven't matured with the business — and growth begins to compound risk.",
  },
];
...
const pillars = [
  {
    key: "Strategy",
    icon: Compass,
    line: "Clarity of where to play and how to win.",
    body: "We pressure-test strategic theses, sharpen value-creation plans, and align the executive team around the few moves that matter most.",
  },
  {
    key: "Leadership",
    icon: Crown,
    line: "The team you have, made into the team you need.",
    body: "Senior leadership coaching, team effectiveness, and assessment — engineered around the demands of the next chapter.",
  },
  {
    key: "Talent",
    icon: Users2,
    line: "Right leaders. Right roles. Right time.",
    body: "Executive search, succession architecture, and bench strength built for inflection — not maintenance.",
  },
  {
    key: "Execution",
    icon: Workflow,
    line: "Operating cadence that compounds.",
    body: "Decision rights, governance, and rhythm that turn intent into measurable, repeatable outcomes.",
  },
];
...
const services = [
  {
    ...
    body: "Confidential identification and placement of board, C-suite, and senior leaders.",
    to: "/services/executive-search",
  },
  {
    icon: BarChart3,
    title: "Leadership Assessment",
    body: "Predictive insight into capability, fit, and trajectory at the most consequential roles.",
    to: "/services/leadership-assessment",
  },
  {
    icon: Network,
    title: "Organizational Strategy",
    body: "Aligning structure, decision rights, and operating model to strategic intent.",
    to: "/services/organizational-strategy",
  },
  {
    icon: GraduationCap,
    title: "Leadership Development",
    body: "Bespoke programs that move executives from capable to indispensable.",
  },
  {
    icon: Briefcase,
    title: "Talent Advisory",
    body: "Workforce architecture, capability mapping, and critical-role strategy.",
  },
  {
    icon: Lightbulb,
    title: "Executive Coaching",
    body: "1:1 partnership with senior operators navigating ambiguity and scale.",
  },
  {
    icon: Layers,
    title: "Succession Planning",
    body: "Architected pipelines and readiness systems for board and C-suite continuity.",
  },
  {
    icon: Target,
    title: "Growth Alignment",
    body: "Bringing strategy, leadership, talent, and execution into a single integrated motion.",
...
const stories = [
  {
    ...
    title: "Resetting the Top Team Before the Next Hold Period",
    challenge:
      "An $800M PE-backed industrial company entered a critical 18-month value-creation window with a misaligned executive team and a CEO succession on the horizon.",
    impact:
      "Repositioned three leadership roles, installed a new CFO, and operationalized a board-ready succession architecture — exit multiple expanded by 1.7x.",
    metric: "1.7x",
    metricLabel: "exit multiple expansion",
  },
  {
    tag: "Healthcare Services",
    title: "From Founder-Led to Institutional-Grade",
    challenge:
      "A founder-led specialty platform needed to graduate to a professional operating model without losing the cultural edge that built it.",
    impact:
      "Designed a new operating cadence, recruited two division presidents, and stood up an executive team responsible for $1.2B in projected revenue.",
    metric: "$1.2B",
    metricLabel: "in revenue scope built",
  },
  {
    tag: "Industrial Manufacturing",
    title: "Aligning Strategy, Structure, and the Next CEO",
    challenge:
      "A 70-year-old industrial leader faced generational transition and a strategy that no longer matched its market.",
    impact:
      "Led an integrated strategy, structure, and succession reset with the board — culminating in a successful internal CEO transition.",
    metric: "100%",
    metricLabel: "internal succession",
  },
];
          ...
          <div className="md:col-span-7">
            ...
            <Reveal delay={120}>
              <h1 className="font-display mt-7 text-5xl font-light leading-[1.02] tracking-[-0.02em] text-gradient md:text-7xl lg:text-[80px]">
                Integrated Growth.
                <br />
                <span className="italic font-light text-white/95">Grounded in Strategy.</span>
                <br />
            ...
            <Reveal delay={260}>
              <p className="mt-8 max-w-xl text-lg leading-relaxed text-muted-foreground md:text-xl">
                HALO Growth Partners partners with executive teams, investors, and organizations
                navigating growth, transformation, and critical inflection points.
              </p>
            </Reveal>
            <Reveal delay={400}>
            ...
            <Reveal delay={300}>
              <div className="relative mx-auto aspect-square w-full max-w-[520px]">
                ...
                <div
                  ...
                  style={{ boxShadow: "inset 0 0 120px oklch(0.65 0.2 240 / 0.25)" }}
                />
                <div className="absolute inset-0 animate-[spin_60s_linear_infinite]">
                  {pillars.map((p, i) => {
                    ...
                    return (
                      ...
                      >
                        <div
                          className="glass rounded-xl px-3 py-2 text-xs font-medium tracking-wide text-white/90 animate-[spin_60s_linear_infinite_reverse]"
                ...
                <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 text-center">
                  ...
                  <div className="font-display mt-2 text-2xl font-light text-gradient">
                    Growth Model
                  </div>
        ...
        <div className="container-elite">
          <Reveal>
            <p className="mx-auto max-w-2xl text-center text-sm text-muted-foreground md:text-base">
              Trusted by growth-focused leadership teams navigating complexity, transformation, and
              scale.
            </p>
          </Reveal>
          <div
          ...
          >
            <div className="flex w-max items-center gap-16 animate-scroll-x">
              {[...trustLogos, ...trustLogos].map((l, i) => (
                <div
                  key={i}
                  className="font-display text-xl font-light tracking-[0.18em] text-white/40 hover:text-white/80 transition-colors whitespace-nowrap"
                >
                  {l.toUpperCase()}
                </div>
              ))}
            ...
            <div className="md:col-span-5 md:sticky md:top-32 md:self-start">
              ...
              <Reveal delay={260}>
                <p className="mt-6 max-w-md text-base leading-relaxed text-muted-foreground md:text-lg">
                  Most strategies don't fail in the deck. They fail in the space between the
                  executive team's intent and the organization's ability to execute. Our work lives
                  in that space.
                </p>
              </Reveal>
              <Reveal delay={400}>
          ...
          <div className="mx-auto max-w-3xl text-center">
            ...
            <Reveal delay={240}>
              <p className="mx-auto mt-6 max-w-2xl text-base leading-relaxed text-muted-foreground md:text-lg">
                Four interlocking pillars. One operating system for value creation. Built for
                leadership teams who can no longer afford to treat strategy, talent, and execution
            ...
            <div className="md:col-span-5">
              <Reveal delay={200}>
                <p className="text-base leading-relaxed text-muted-foreground md:text-lg">
                  Engaged together — or sequenced as the moment requires — to move organizations
                  from strategic intent to measurable executive performance.
                </p>
              </Reveal>
            </div>
          </div>
        ...
        <div className="container-elite">
          <div className="flex flex-wrap items-end justify-between gap-6">
            ...
            <Link to="/stories" className="btn-ghost">
              All client stories <ArrowUpRight className="h-4 w-4" />
            </Link>
          </div>
            ...
            {stories.map((s, i) => (
              <Reveal key={s.title} delay={i * 120}>
                <article className="card-elite group flex h-full flex-col p-8">
                  ...
                  <h3 className="font-display mt-4 text-2xl font-light leading-tight tracking-tight text-white">
                    {s.title}
                  </h3>
                  ...
                  <div className="mt-8 flex items-end justify-between border-t border-white/5 pt-6">
                    <div>
                      <div className="font-display text-3xl font-light text-electric">
                        {s.metric}
                      </div>
            ...
            <Reveal className="lg:col-span-7">
              <Link to="/insights" className="card-elite group block h-full overflow-hidden">
                <div className="relative aspect-[16/10] overflow-hidden">
                  ...
                  <div className="absolute right-8 top-8 text-[11px] uppercase tracking-[0.24em] text-white/50">
                    2025 Index
                  </div>
                </div>
                <div className="p-10">
                  ...
                  <h3 className="font-display mt-4 text-3xl font-light leading-tight tracking-tight text-white md:text-4xl">
                    The Executive Capability Index — what separates the top decile of leadership
                    teams in 2025.
                  </h3>
                  <p className="mt-5 max-w-xl text-[15px] leading-relaxed text-muted-foreground">
                    A two-year study of 312 executive teams across PE-backed and public companies —
                    and what their highest performers do differently when growth gets harder.
                  </p>
                ...
                <Reveal key={p.title} delay={i * 100}>
                  <Link to="/insights" className="card-elite group flex items-start gap-5 p-6">
                    ...
                    <div className="flex-1">
                      ...
                      <h4 className="font-display mt-2 text-xl font-light leading-snug tracking-tight text-white">
                        {p.title}
                      </h4>
                    </div>
