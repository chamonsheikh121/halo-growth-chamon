...
export const Route = createFileRoute("/services/executive-search")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Confidential identification, calibration, and placement of senior executives.",
      },
      { property: "og:title", content: "Executive Search" },
      {
        property: "og:description",
        content: "Search engineered for inflection points — not maintenance hires.",
      },
    ],
  }),
  component: () => (
    <ServiceTemplate
      ...
      whatWeDeliver={[
        {
          t: "Strategic Role Calibration",
          d: "We design the role to the strategy — not the org chart of the past.",
        },
        {
          t: "Targeted Market Mapping",
          d: "Quiet, comprehensive identification of the few candidates who can actually do the job.",
        },
        {
          t: "Calibrated Assessment",
          d: "Behavioral, cognitive, and contextual data — not just references and résumés.",
        },
        {
          t: "Board & Sponsor Alignment",
          d: "We bring the board, CEO, and sponsor into one shared standard for the seat.",
        },
        {
          t: "Confidential Engagement",
          d: "Discreet outreach that protects the candidate, the company, and the search.",
        },
        {
          t: "Onboarding & Integration",
          d: "First-90 and first-180 day support so the placement compounds, not stalls.",
        },
      ]}
      outcomes={[
